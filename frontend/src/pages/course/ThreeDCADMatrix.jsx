...
const courseContent = [
  ...
  "Basics of Curves, Surface & Solids",
  "Parametric Modeling and Design",
  "Diamond builder & cutter",
  "Different Types of Stone shapes",
  "Realistic Visualization and Rendering",
  "Develop setting in Matrix Software",
    ...
    <div className="course-page">
      <style>{`
        * {
        ...
        .cad-card:hover {
          ...
          box-shadow:
            0 0 35px rgba(255, 210, 86, 0.12),
            inset 0 0 35px rgba(255, 210, 86, 0.04);
        }
        ...
        .cad-orbit {
          ...
          border: 2px solid rgba(255, 218, 105, 0.45);
          border-radius: 50%;
        ...
        .cad-orbit::after {
          ...
          border: 2px solid rgba(255, 218, 105, 0.35);
          border-radius: 50%;
        }
        ...
        .cad-center {
          ...
          box-shadow:
            0 0 25px rgba(255, 211, 91, 0.2),
            inset 0 0 20px rgba(255, 211, 91, 0.08);
        }
      ...
      <div className="page-inner">
        <section className="hero">
          ...
          <div className="hero-grid">
            ...
            <p className="hero-subtitle">
              <strong>3D CAD Matrix Course</strong> in Jaipur
            </p>
          </div>
        </section>
        ...
        <section className="section">
          <div className="section-container">
            <div className="section-heading">
              <div className="section-label">3D CAD Matrix</div>
              <h2>Design In Three Dimensions</h2>
              <p>
                Discover the visual world of curves, surfaces, solids,
                modeling and rendering.
              </p>
            </div>

            <div className="cad-showcase">
              <div className="cad-card large">
                <div className="cad-lines"></div>
                <div className="cad-orbit"></div>
                <div className="cad-center"></div>

                <div className="cad-card-content">
                  <small>01</small>
                  <h3>Curves, Surface & Solids</h3>
                </div>
              </div>
...
export default ThreeDCADMatrix;