...
/**
 * WebThreads
 * Official React Bits WebThreads component from https://reactbits.dev/backgrounds/web-threads
 */
const WebThreads = ({
  color1 = '#f6d96b',
  color2 = '#eab308',
  ...
  useEffect(() => {
    ...
    try {
      ...
      console.warn('Could not create WebGL2 context:', e);
      return;
    }
    ...
    // Global passive mouse move to ensure tracking across overlying hero elements
